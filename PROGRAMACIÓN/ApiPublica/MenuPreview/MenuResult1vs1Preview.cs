...
namespace ApiPublica
{
    public partial class MenuResult1vs1PreviewModel : UserControl
    {
        ...
        {
            new FormPincipalMenu().ShowFullInformation(_idteam1,_idteam2,_team1, _team2,_competition,_startTime,_endTime,_date,_stadium,_score1,_score2);
        }
        ...
        private void MenuResult1vs1PreviewModel_Load(object sender, EventArgs e)
        {
