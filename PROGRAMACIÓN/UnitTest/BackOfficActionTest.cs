...
namespace UnitTest
{
    ...
    public class BackOfficActionTest
    {
        ...
        public void Register()
        {
            ...
            ActionControler.Alta(new TeamControler().GetId("Test2"),new PlayerControler().GetId("Test2"),new EventControler().GetIdTime(1),1, "Test2", "Test2", "1111-11-11", "Test2","Test2");
            bool response = new ActionControler().ExistAction(new ActionControler().GetId("Test2"));
        ...
        public void Modify()
        {
            ...
            ActionControler.Alta(new TeamControler().GetId("Test2"), new PlayerControler().GetId("Test2"), new EventControler().GetIdTime(1), 1, "Test", "Test", "1111-11-11", "Test2","Test2");
        ...
        public void Delete()
        {
            ...
            ActionControler.Alta(new TeamControler().GetId("Test2"), new PlayerControler().GetId("Test2"), new EventControler().GetIdTime(1), 1, "Test", "Test", "1111-11-11", "Test","Test");
