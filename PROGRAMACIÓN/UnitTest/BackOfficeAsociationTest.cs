    ...
    public class BackOfficeAsociationTest
    {
        ...
        public void Modify()
        {
            ...
            if (response)
            {
                ...
                AsociationControler.Modificar(id, "Test", "Test", "n", "Test", 1111, "Test", "Test", "1111-11-11", "1111-11-11", new SportControler().GetId("Test2"), "Test", 1);
        ...
        public void Delete()
        {
            ...
            {
                int id = new AsociationControler().GetId("Test");
                AsociationControler.Eliminar(id);
