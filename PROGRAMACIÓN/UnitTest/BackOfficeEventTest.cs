...
namespace UnitTest
{
    ...
    public class BackOfficeEventTest
    {
        ...
        public void Register()
        {
            ...
            EventControler.Alta("Test", "1111-11-11", "1111-11-11",new StageControler().GetId("Test2"),1,"Test", new FamilyControler().GetId("Test2"));
        ...
        public void Modify()
        {
            EventControler.Modify(new EventControler().GetId("Test"), "Test", "2022-10-27", "1111-11-11", new StageControler().GetId("Test2"), 1, "Test");
